...
export const metadata = { title: "Politique de garantie - DJI Store TN" };
    ...
    <>
      <section className="page-head">
        <div className="container">
          ...
          <p>Tous les produits vendus par DJI Store TN beneficient d&apos;une couverture garantie complete.</p>
        </div>
      </section>
      ...
      <section className="section">
        <div className="container" style={{ maxWidth: "760px" }}>
          {[
            { titre: "Garantie standard - 2 ans", contenu: "Tous les produits neufs achetes sur DJI Store TN sont couverts par une garantie de 2 ans a compter de la date de livraison. Cette garantie couvre les defauts de fabrication et les pannes materielles survenant dans des conditions normales d'utilisation." },
            ...
            { titre: "Remplacement et reparation", contenu: "En cas de produit defectueux couvert par la garantie, DJI Store TN s'engage a reparer ou remplacer le produit sans frais supplementaires. Les frais de retour sont pris en charge par DJI Store TN." },
          ].map((section) => (
